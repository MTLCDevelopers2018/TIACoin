...
const string strMessageTIACoin = "TIACoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TIACoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //block.GetHash() == 000008c98ad4dbbbcfd89dc8ce6dbc889d26853fe7c7c17151115047c40aa236
        //block.hashMerkleRoot == 4ef2c961d5ed7c943571a237e05eda52dbd5471ace2fbbb30fca25cfd56e6c27
        //block.nTime = 1543362910 
        //block.nNonce = 634702

        const char* pszTimestamp = "This Is Africa Dec 2018";
        CTransaction txNew;
        txNew.nTime = 1543362910;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 634702 : 0;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x4ef2c961d5ed7c943571a237e05eda52dbd5471ace2fbbb30fca25cfd56e6c27"));
